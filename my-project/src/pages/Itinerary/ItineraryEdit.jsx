...
import { faChevronLeft, faLocationDot, faCircleCheck, faCircle, faChevronDown } from '@fortawesome/free-solid-svg-icons'

export default class ItineraryEdit extends Component {
  render() {
    return (
        // == 編輯行程頁 start ==
        <>
